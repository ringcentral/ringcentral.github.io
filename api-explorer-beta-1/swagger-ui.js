...
this["Handlebars"]["templates"]["operation"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  var helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression;
  var responseStatus, responseStatusHeader;
  responseStatus = escapeExpression(((helper = (helper = helpers.successCode || (depth0 != null ? depth0.successCode : depth0)) != null ? helper : helperMissing), (typeof helper === functionType ? helper.call(depth0, { "name": "successCode", "hash": {}, "data": data }) : helper)));
  if (responseStatus != "default")
  { responseStatusHeader = "Response Class (Status " + responseStatus + ")"; }
  else
  { responseStatusHeader = "Response Class";}
  return "          <h4>" + responseStatusHeader + "</h4>\n          <p><span class=\"model-signature\" /></p>\n          <br/>\n          <div class=\"response-content-type\" />\n";
...
OperationView = (function(_super) {
  ...
  OperationView.prototype.submitOperation = function(e) {
    ...
    if (
      parDivId == "Authentication_oauth_token_post_content" ||
      parDivId == "Authentication_oauth_revoke_post_content"
    ) {
      $('#input_apiKey').val("");
      ...
      if ( app_key.length>0 && app_secret.length>0 ) {
        ...
        window.authorizations.add("key", new ApiKeyAuthorization("Authorization", authzVal, "header"));
      }
    }
